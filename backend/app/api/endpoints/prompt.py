"""
POST /prompt -- Prompt injection detection endpoint.
"""
...
from app.models.schemas import AnalysisResponse, PromptAnalysisRequest
...
async def analyze_prompt(request: PromptAnalysisRequest):
    ...
    highlighted_segments = result.get("extra_data", {}).get("highlighted_segments", [])
    ...
    # 6. Build response with highlighted_segments in extra_data
    response = AnalysisResponse(
        ...
        extra_data={"highlighted_segments": highlighted_segments},
    )
